...
const wrapper = __importStar(require("./handles/handleWrapper"));
class mySqlPersistence {
    getPersistenceName() {
        return 'My SQL Server';
    }
    addDiscarted(imei, remoteAddress, message, data) {
    ...
    addBatteryLevel(imei, remoteAddress, batteryLevel) {
        return wrapper.handleAddBatteryLevel(imei, remoteAddress, batteryLevel);
    }
    addHistory(imei, remoteAddress, data) {
