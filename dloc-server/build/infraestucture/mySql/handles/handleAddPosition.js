...
exports.handleAddPosition = void 0;
...
const handleAddPosition = (positionPacket) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    /** Update device */
    yield (0, handleUpdateDevice_1.handleUpdateDevice)(positionPacket);
    /** Add position */
    const params = [
        /** position */
        positionPacket.imei,
...
exports.handleAddPosition = handleAddPosition;
